...
const ForgotPassword = () => {
  ...
  return (
    <div>
      ...
      <p className=" text-gray-dark text-sm">Kindly input your email address to receive OTP to reset your Password</p>
      <form className="my-6" onSubmit={handleSubmit(handleForgotPassword)}>
