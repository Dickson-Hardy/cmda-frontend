...
const DESKTOP_STEPS = [
  // Welcome
  {
    ...
    description:
      "Let us show you around the dashboard. This quick tour will help you get started with managing your membership.",
    targetSelector: null,
    position: "center",
  },
  // Home Overview
  {
    ...
    description:
      "This is your home base. Here you can see daily devotionals, upcoming events, resources, and connect with other members.",
  ...
  },
  {
    ...
    description:
      "View and manage your CMDA membership subscription. Keep your membership active to access all premium features.",
  ...
  // Events
  {
    ...
    description:
      "Discover upcoming conferences, training sessions, and fellowship events. Register and stay connected.",
  ...
  // Resources
  {
    ...
    description:
      "Access devotionals, articles, videos, and other resources to support your faith and professional journey.",
  ...
  // Faith Entry
  {
    ...
    title: "Faith Entry",
    description:
      "Share testimonies, prayer requests, and comments with the community. Support and encourage one another.",
  ...
  // Profile
  {
    ...
    title: "Your Profile",
    description:
      "Update your personal information, preferences, and account settings. You can also restart this tutorial from here.",
  ...
  // Completion
  {
    ...
    description:
      "You now know your way around CMDA. If you ever need this tour again, you can restart it from your Profile settings.",
    targetSelector: null,
    position: "center",
  },
];
