...
const ProgressIndicator = ({ currentStep, totalSteps }) => {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{`Progress: ${Math.round(((currentStep + 1) / totalSteps) * 100)}% complete`}</span>

      {/* Visual progress dots */}
      <div className="flex items-center justify-center gap-2" role="list" aria-label="Tutorial steps">
